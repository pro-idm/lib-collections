...
Процедура Тест_ЛА_ИдентификаторыИНеизвестныеТокены() Экспорт	
	...
	ТокеныШаблон = ЗначенияВМассив(
		Токен("Идентификатор", "МойТест"),
		Токен("Неизвестный", "+"),
		Токен("Идентификатор", "Rr"),
		Токен("Неизвестный", "/"),
		Токен("Идентификатор", "И"),
		Токен("Неизвестный", "*-"),
		Токен("Идентификатор", "_Бора_")
	);
	ПроверитьРавенствоМассивовТокенов(ТокеныШаблон, Токены);
КонецПроцедуры
...
Процедура Тест_ЛА_ВызовФункции() Экспорт	
	...
	ТокеныШаблон = ЗначенияВМассив(
		Токен("Идентификатор", "ЭтотОбъект"),
		Токен("Точка", "."),
		Токен("Идентификатор", "_ВызватьМоюФункцию"),
		Токен("ЛеваяСкобка", "("),
		Токен("Идентификатор", "Параметр1"),
		Токен("Неизвестный", ","),
		Токен("Идентификатор", "Параметр2"),
		Токен("ПраваяСкобка", ")"),
		Токен("ТочкаСЗапятой", ";")
	);
	ПроверитьРавенствоМассивовТокенов(ТокеныШаблон, Токены);
...
Процедура Тест_СА_ПараметрСПолем() Экспорт
	...
	Токены = ЗначенияВМассив(
		Токен("Идентификатор", "Параметр"),
		Токен("Точка", "."),
		Токен("Пробелы", "  "),
		Токен("Идентификатор", "Поле")
	);
	
	ТокеныШаблон = ЗначенияВМассив(
		Токен("Параметр", "Параметр"),
		Токен("Точка", "."),
		Токен("Пробелы", "  "),
		Токен("Поле", "Поле")
	);
...
Процедура Тест_СА_ПеременнаяВЕсли() Экспорт
	...
	Токены = ЗначенияВМассив(
		Токен("Идентификатор", "Если"),
		Токен("Пробелы", " "),
		Токен("Идентификатор", "Истина"),
		Токен("Пробелы", " "),
		Токен("Идентификатор", "Тогда"),
		Токен("Пробелы", " "),
		Токен("Идентификатор", "Р"),
		Токен("Равно", "="),
		Токен("Неизвестный", "1")
	);
	ДобавитьЗначенияВМассив(Токены,
		Токен("ТочкаСЗапятой", ";"),
		Токен("Пробелы", " "),
		Токен("Идентификатор", "КонецЕсли"),
		Токен("ТочкаСЗапятой", ";"),
	);
	
	ТокеныШаблон = ЗначенияВМассив(
		Токен("КлючевоеСлово", "Если"),
		Токен("Пробелы", " "),
		Токен("КлючевоеСлово", "Истина"),
		Токен("Пробелы", " "),
		Токен("КлючевоеСлово", "Тогда"),
		Токен("Пробелы", " "),
		Токен("Переменная", "Р"),
		Токен("Равно", "="),
		Токен("Неизвестный", "1")
	);
	ДобавитьЗначенияВМассив(ТокеныШаблон,
		Токен("ТочкаСЗапятой", ";"),
		Токен("Пробелы", " "),
		Токен("КлючевоеСлово", "КонецЕсли"),
		Токен("ТочкаСЗапятой", ";"),
	);
...
Процедура Тест_СА_ПеременнаяВЦикле() Экспорт
	...
	Токены = ЗначенияВМассив(
		Токен("Идентификатор", "Пока"),
		Токен("Пробелы", " "),
		Токен("Идентификатор", "Индекс"),
		Токен("Равно", "="),
		Токен("Неизвестный", "1"),
		Токен("Пробелы", " "),
		Токен("Идентификатор", "Цикл"),
		Токен("Пробелы", " ")
	);
	ДобавитьЗначенияВМассив(Токены,
		Токен("Идентификатор", "Р"),
		...
		Токен("ТочкаСЗапятой", ";"),
		Токен("Пробелы", " "),
		Токен("Идентификатор", "КонецЦикла")
	);
	
	ТокеныШаблон = ЗначенияВМассив(
		Токен("КлючевоеСлово", "Пока"),
		Токен("Пробелы", " "),
		Токен("Идентификатор", "Индекс"),
		Токен("Равно", "="),
		Токен("Неизвестный", "1"),
		Токен("Пробелы", " "),
		Токен("КлючевоеСлово", "Цикл"),
		Токен("Пробелы", " ")
	);
	ДобавитьЗначенияВМассив(ТокеныШаблон,
		Токен("Переменная", "Р"),
		...
		Токен("ТочкаСЗапятой", ";"),
		Токен("Пробелы", " "),
		Токен("КлючевоеСлово", "КонецЦикла")
	);
...
Процедура Тест_СА_ПеременнаяВДля() Экспорт
	...
	Токены = ЗначенияВМассив(
		Токен("Идентификатор", "Для"),
		Токен("Пробелы", " "),
		Токен("Идентификатор", "Индекс"),
		Токен("Равно", "="),
		Токен("Неизвестный", "1"),
		Токен("Пробелы", " "),
		Токен("Идентификатор", "По"),
		Токен("Пробелы", " ")
	);
	ДобавитьЗначенияВМассив(Токены,
		Токен("Неизвестный", "10"),
		Токен("Пробелы", " "),
		Токен("Идентификатор", "Цикл"),
		Токен("ТочкаСЗапятой", ";"),
		Токен("Пробелы", " "),
	...
	ТокеныШаблон = ЗначенияВМассив(
		Токен("КлючевоеСлово", "Для"),
		Токен("Пробелы", " "),
		Токен("Переменная", "Индекс"),
		Токен("Равно", "="),
		Токен("Неизвестный", "1"),
		Токен("Пробелы", " "),
		Токен("КлючевоеСлово", "По"),
		Токен("Пробелы", " ")
	);
	ДобавитьЗначенияВМассив(ТокеныШаблон,
		Токен("Неизвестный", "10"),
...
Функция СоздатьАнализатор()
	Возврат Обработки.АнализаторКода.Создать();
КонецФункции 

Процедура ПроверитьРавенствоМассивовТокенов(МассивШаблон, МассивПроверяемый)
	Утверждения.ПроверитьРавенство(МассивШаблон.Количество(), МассивПроверяемый.Количество(), "Количество токенов отличается!");
...
Функция ЗначенияВМассив(Значение1, Значение2 = Неопределено, Значение3 = Неопределено, Значение4 = Неопределено, Значение5 = Неопределено,
	                    Значение6 = Неопределено, Значение7 = Неопределено, Значение8 = Неопределено, Значение9 = Неопределено)
...
Процедура ДобавитьЗначенияВМассив(Массив, Значение1, Значение2 = Неопределено, Значение3 = Неопределено, Значение4 = Неопределено, Значение5 = Неопределено,
	                    Значение6 = Неопределено, Значение7 = Неопределено, Значение8 = Неопределено, Значение9 = Неопределено)
