...
Процедура Инициализация(КонтекстЯдраПараметр) Экспорт
	...
	МодульАнализКода = Вычислить("А_АнализКода");
КонецПроцедуры
...
Процедура Тест_ЛА_ПустойКод() Экспорт
	Токены = МодульАнализКода.ЛексическийАнализ("");
...
Процедура Тест_ЛА_Пробелы() Экспорт
	...
	Токены = МодульАнализКода.ЛексическийАнализ(Код);
...
Процедура Тест_ЛА_Идентификатор() Экспорт
	Токены = МодульАнализКода.ЛексическийАнализ("Тест");
...
Процедура Тест_ЛА_ИдентификаторСПодчеркиванием() Экспорт
	Токены = МодульАнализКода.ЛексическийАнализ("___1Т2009русeng_1");
...
Процедура Тест_ЛА_ИдентификаторыИНеизвестныеТокены() Экспорт
	Токены = МодульАнализКода.ЛексическийАнализ("МойТест+Rr/И*-_Бора_");
...
Процедура Тест_ЛА_ВызовФункции() Экспорт
	Токены = МодульАнализКода.ЛексическийАнализ("ЭтотОбъект._ВызватьМоюФункцию(Параметр1,Параметр2);");
...
Процедура Тест_СА_ОдинПараметр() Экспорт
	...
	МодульАнализКода.СинтаксическийАнализ(Токены, Параметры);
	ПроверитьРавенствоМассивовТокенов(ТокеныШаблон, Токены);
КонецПроцедуры
...
Процедура Тест_СА_КлючевыеСлова() Экспорт
	...
	МодульАнализКода.СинтаксическийАнализ(Токены, Новый Массив);
	ПроверитьРавенствоМассивовТокенов(ТокеныШаблон, Токены);
КонецПроцедуры
...
Процедура Тест_ДобавитьПолучениеРезультата_ОдноВыражение() Экспорт
	...
	КодРезультат = МодульАнализКода.ДобавитьПолучениеРезультата(Код, ПеременнаяРезультат);
...
Процедура Тесты_ПолучитьКодДляВстраивания_ОдноВыражение() Экспорт
	...
	КодРезультат = МодульАнализКода.ПодготовитьКодДляВстраивания(Код, Новый Структура, , "__Условие");
	Утверждения.ПроверитьРавенство(КодШаблон, КодРезультат);
КонецПроцедуры
...
Процедура Тесты_ПолучитьКодДляВстраивания_ВыражениеОдинПараметр() Экспорт
	...
	КодРезультат = МодульАнализКода.ПодготовитьКодДляВстраивания(Код, ПодстановкаПараметров, , "Результат");
	Утверждения.ПроверитьРавенство(КодШаблон, КодРезультат);
КонецПроцедуры
...
Процедура Тесты_ПолучитьКодДляВстраивания_ВыражениеСПараметрами() Экспорт
	...
	КодРезультат = МодульАнализКода.ПодготовитьКодДляВстраивания(Код, ПодстановкаПараметров, , "__Условие");
	Утверждения.ПроверитьРавенство(КодШаблон, КодРезультат);
КонецПроцедуры
...
Процедура Тесты_ПолучитьКодДляВстраивания_ВыражениеСПеременными() Экспорт
	...
	КодРезультат = МодульАнализКода.ПодготовитьКодДляВстраивания(Код, Замены, "__Перем", "__Условие");
	Утверждения.ПроверитьРавенство(КодШаблон, КодРезультат);
КонецПроцедуры
...
Процедура Тесты_ПолучитьКодДляВстраивания_СКонтекстом() Экспорт
	...
	КодРезультат = МодульАнализКода.ПодготовитьКодДляВстраивания(Код, Замены, "__Перем");
	Утверждения.ПроверитьРавенство(КодШаблон, КодРезультат);
КонецПроцедуры
