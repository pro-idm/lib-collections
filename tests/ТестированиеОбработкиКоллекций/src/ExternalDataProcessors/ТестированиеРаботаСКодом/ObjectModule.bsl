...
Процедура Тест_СА_Новый() Экспорт
	...
	Токены = ЗначенияВМассив(
		Токен("Идентификатор", "Массив"), Токен("Пробелы", " "), Токен("Равно", "="),
		Токен("Пробелы", " "), Токен("Идентификатор", "Новый"), Токен("Пробелы", " "), Токен("Идентификатор", "Массив")
	);

	ТокеныШаблон = ЗначенияВМассив(
		Токен("Переменная", "Массив"), Токен("Пробелы", " "), Токен("Равно", "="),
		Токен("Пробелы", " "), Токен("КлючевоеСлово", "Новый"), Токен("Пробелы", " "), Токен("Функция", "Массив")
	);
