...
Процедура Инициализация(КонтекстЯдраПараметр) Экспорт
	...
	Коллекции = Вычислить("А_КоллекцииСервер");
КонецПроцедуры
...
Процедура ДляКаждого_Параметр_НеКоллекция() Экспорт
	...
	Выражение = "";
	Попытка
		Коллекции.ДляКаждого(Коллекция, Выражение);
	Исключение
...
Процедура ДляКаждого_Параметр_КонтекстНеСтруктура() Экспорт
	...
	Контекст = "";
	Попытка
		Коллекции.ДляКаждого(Коллекция, Выражение, Контекст);
	Исключение
		ТекстИсключения = ИнформацияОбОшибке().Описание;
	КонецПопытки;
...
Процедура Фильтр_Параметр_НеКоллекция() Экспорт
	...
	Выражение = "";
	Попытка
		Коллекции.Фильтр(Коллекция, Выражение);
	Исключение
		ТекстИсключения = ИнформацияОбОшибке().Описание;
	КонецПопытки;
...
Процедура Фильтр_Параметр_КонтекстНеСтруктура() Экспорт
	...
	Контекст = "";
	Попытка
		Коллекции.Фильтр(Коллекция, Выражение, Контекст);
	Исключение
		ТекстИсключения = ИнформацияОбОшибке().Описание;
	КонецПопытки;
...
Процедура Фильтр_Пустой_Массив() Экспорт
	...
	КоллекцияРезультат = Коллекции.Фильтр(Коллекция, Выражение);
...
Процедура Фильтр_Массив() Экспорт
	...
	КоллекцияРезультат = Коллекции.Фильтр(Коллекция, Выражение, Контекст);
...
Процедура ПреобразоватьВМассив_Параметр_НеКоллекция() Экспорт
	...
	Выражение = "";
	Попытка
		Коллекции.ПреобразоватьВМассив(Коллекция, Выражение);
	Исключение
		ТекстИсключения = ИнформацияОбОшибке().Описание;
	КонецПопытки;
...
Процедура ПреобразоватьВМассив_Параметр_КонтекстНеСтруктура() Экспорт
	...
	Контекст = "";
	Попытка
		Коллекции.ПреобразоватьВМассив(Коллекция, Выражение, Контекст);
	Исключение
		ТекстИсключения = ИнформацияОбОшибке().Описание;
	КонецПопытки;
...
Процедура ПреобразоватьВМассив_Пустой_Массив() Экспорт
	...
	КоллекцияРезультат = Коллекции.ПреобразоватьВМассив(Коллекция, Выражение);
