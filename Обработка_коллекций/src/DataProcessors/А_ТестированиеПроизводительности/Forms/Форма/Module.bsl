...
Функция ЛямбдаФильтрМассив(Коллекция)
	Возврат А_КоллекцииСервер.Фильтр(Коллекция, "Элемент % Делитель = 0", Новый Структура("Делитель", 10));
КонецФункции

&НаСервереБезКонтекста
Функция ЛямбдаФильтрТаблицаСписокЗначений(Коллекция)
	Возврат А_КоллекцииСервер.Фильтр(Коллекция, "Элемент.Значение % Делитель = 0", Новый Структура("Делитель", 10));
КонецФункции
